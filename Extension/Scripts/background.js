...
async function checkUrl_virustotal(url) {
    ...
    try {
        ...
        // Displays how many of the sources flagged the site as phishing/harmless
...
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
    ...
    // Checks to see if the url has been checked recently
    ...
    // Returns the result from previous requests
    ...
    // Checks the url for phishing - send requests to the APIs
    if (msg.action === "checkPhish" && msg.url) {
        (async () => {
            ...
            result = {
                ...
                v_score: risk_score,
                virustotal_num_score: virustotal_score,
                unsafe_site_score: unsafe_site_score,
                suspicious_site_score: suspicious_site_score
            };
